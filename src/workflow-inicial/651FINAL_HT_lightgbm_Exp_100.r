...
# pensado para datasets con UNDERSAMPLING de la clase mayoritaria
...
PARAM <- list()
PARAM$experimento <- "HT6510_versionfinal1_SPOSW100"

PARAM$exp_input <- "TS6410_versionfinal_FTyT_B"

# En caso que se haga cross validation, se usa esta cantidad de folds
PARAM$lgb_crossvalidation_folds <- 5

PARAM$lgb_semilla <- 106791 # cambiar por su propia semilla
...
#Hiperparametros para enfrentar el desbalanceo
