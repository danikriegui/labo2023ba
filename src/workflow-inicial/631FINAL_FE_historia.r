...
PARAM <- list()
PARAM$experimento <- "FE6310_versionfinal_LAGyCAN"

PARAM$exp_input <- "DR6210_versionfinal_D"
...
PARAM$RandomForest$semilla <- 106791 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 300177
